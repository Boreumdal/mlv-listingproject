function initializeMap() {
    ...
    function current(){
        ...
        if (navigator.geolocation){
            navigator.geolocation.getCurrentPosition(success) // eto po yung nagrerequest ng location
        }
        else {
    ...
    async function success(place){
        ...
        function mainFunc(evt) {
            ...
            let pointedMarker = new H.map.Marker({lat: Math.abs(coord.lat), lng: Math.abs(coord.lng)})
